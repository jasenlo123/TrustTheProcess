...
class d3LineChart extends D3Component {
  initialize(node, props) {
    ...
    const xAxis = g => g
      ...
      .call(d3.axisBottom(x).ticks(size/ 80).tickSizeOuter(0))
   ...
   .attr("stroke-size", d => d.currency === props.highlight? 3 : d.students/10);
